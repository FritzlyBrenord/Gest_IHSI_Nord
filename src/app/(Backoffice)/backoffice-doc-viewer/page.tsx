...
function DocViewerContent() {
  ...
  const backUrl = searchParams.get('back') || '/meetings';
            ...
            <div className="min-w-0">
              ...
              {doc?.workflowStatus && (
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  {doc.visibility === 'prive' && <span className="inline-flex items-center gap-1 text-[10px] text-gray-400"><Lock className="w-3 h-3" /> Privé</span>}
                </div>
              )}
            </div>
          </div>
...
export default function BackofficeDocViewerPage() {
  return (
